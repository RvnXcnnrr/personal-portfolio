...
export const personalInfo = {
  ...
  website: 'https://javy-portfolio.netlify.app',
  ...
  bio: {
    ...
    goals: [
      ...
      'Build a strong portfolio of diverse web projects',
      'Contribute to open-source projects',
      'Land my first full-time developer role after graduation'
    ]
  },
  ...
  // Social links
  social: {
    github: 'https://github.com/RvnXcnnrr',
    linkedin: 'https://linkedin.com/in/javy-rodillon', // Update with real profile
    facebook: '#',
    instagram: '#',
    twitter: '#'
  }
